...
def ai(txt):
    ...
    response = model.generate_content("from now your name is ram and your a professor and reference , your real name is Ramana R S and reply to this in short: "+txt)
